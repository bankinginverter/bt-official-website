      ...
      <section className="py-20 px-6 max-w-7xl mx-auto relative z-10">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <p className="text-sm md:text-base text-slate-600 dark:text-white/60 font-medium transition-colors">
            ยกระดับการจัดงานของคุณให้เป็นมืออาชีพด้วยระบบจัดการที่ครอบคลุมทุกขั้นตอน
        ...
        <div className="grid grid-cols-1 gap-8 md:gap-12 max-w-5xl mx-auto">
          ...
          <div className="bg-white dark:bg-white/5 border border-slate-100 dark:border-white/10 shadow-xl dark:shadow-none shadow-slate-200/50 rounded-3xl overflow-hidden hover:shadow-2xl dark:hover:shadow-none hover:shadow-slate-200 dark:hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 flex flex-col md:flex-row group">
            <div className="relative w-full md:w-2/5 h-64 md:h-auto md:min-h-[300px] overflow-hidden border-b md:border-b-0 md:border-r border-slate-100 dark:border-white/10">
              <Image
                src="/event1.png"
                alt="Seamless Registration System"
                fill
            ...
            <div className="p-8 md:p-12 flex-1 flex flex-col justify-center space-y-4">
              ...
              <p className="text-base text-slate-500 dark:text-white/60 leading-relaxed transition-colors">
                จัดการการลงทะเบียนหน้างานได้อย่างรวดเร็วและแม่นยำ ลดความแออัด
                และสร้างความประทับใจแรกที่ยอดเยี่ยมให้กับผู้เข้าร่วมงานของคุณด้วยระบบสแกน
                QR Code และการจัดการคิวแบบอัตโนมัติ
              </p>
            </div>
          </div>
          ...
          {/* Card 2 */}
          <div className="bg-white dark:bg-white/5 border border-slate-100 dark:border-white/10 shadow-xl dark:shadow-none shadow-slate-200/50 rounded-3xl overflow-hidden hover:shadow-2xl dark:hover:shadow-none hover:shadow-slate-200 dark:hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 flex flex-col md:flex-row-reverse group">
            <div className="relative w-full md:w-2/5 h-64 md:h-auto md:min-h-[300px] overflow-hidden border-b md:border-b-0 md:border-l border-slate-100 dark:border-white/10">
              <Image
                src="/event2.png"
            ...
            <div className="p-8 md:p-12 flex-1 flex flex-col justify-center space-y-4">
              ...
              <p className="text-base text-slate-500 dark:text-white/60 leading-relaxed transition-colors">
                ดึงดูดผู้เข้าร่วมงานด้วยกิจกรรมและระบบสะสมคะแนนแบบเรียลไทม์
                กระตุ้นให้เกิดการมีส่วนร่วมในทุกโซนของงาน พร้อมแสดงผลขึ้นจอใหญ่
                (Leaderboard) เพื่อเพิ่มความสนุกสนานตื่นเต้น
              </p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-white/5 border border-slate-100 dark:border-white/10 shadow-xl dark:shadow-none shadow-slate-200/50 rounded-3xl overflow-hidden hover:shadow-2xl dark:hover:shadow-none hover:shadow-slate-200 dark:hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 flex flex-col md:flex-row group">
            ...
            <div className="p-8 md:p-12 flex-1 flex flex-col justify-center space-y-4">
              ...
              <p className="text-base text-slate-500 dark:text-white/60 leading-relaxed transition-colors">
                เก็บรวบรวมข้อมูลสำคัญตลอดทั้งงาน
                และสรุปผลออกมาในรูปแบบรายงานที่เข้าใจง่าย
                ช่วยให้คุณสามารถนำข้อมูลไปวิเคราะห์พฤติกรรมผู้ร่วมงานและต่อยอดการตลาดในอนาคตได้อย่างมีประสิทธิภาพ
              </p>
            </div>
          </div>
        </div>
